...
В ходе работы познакомились с языком JavaScript, сравнили его с C#, изучили переменные, типы данных, преобразования типов, условные операторы и запуск кода в браузере и Node.js.
